...
$foto_sidebar = (!empty($avatar_actual) && $avatar_actual != 'default.png') ? 'uploads/' . $avatar_actual : 'https://ui-avatars.com/api/?name=' . urlencode($nombre_usuario) . '&background=00ffa3&color=030712&bold=true';
?>

...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2026 a las 13:00:39
...
(1, 1, 'Bitcoin', 5000.00, 7200.00, '2023-10-01'),
(3, 1, 'Ethereum', 2000.00, 1800.00, '2023-12-20'),
(4, 1, 'Solana', 1000.00, 70.53, '2026-01-29'),
...
INSERT INTO `noticias` (`id`, `titulo`, `contenido`, `fecha`, `autor_id`) VALUES
(1, 'Marcos es gay', 'hola', '2026-05-20 10:03:12', 1);
...
(1, 'marcos', 'marcos@gmail.com', '$2y$10$OAItLD70G5rJ3IxhqRBvC.V1uESGiy0TDlvWoWEopeIJ4Y2Prbhxm', 'admin', 'default.png'),
(2, 'imane', 'imane@gmail.com', '$2y$10$z5frOd2Q9XMkqMcPCWprFe3z1/uPZtValcoWV9J6pgpBnnX0/waWa', 'usuario', 'default.png'),
(3, 'isma', 'isma@gmail.com', '$2y$10$NFUSgQgNBGXbNpHcUevLQuPZnqim8P3zLd1XFyfIaZgICfaNuH/pS', 'admin', 'default.png'),
(4, 'dani', 'dabi@gmail.com', '$2y$10$LgFSQMXfL.mrBiwnoCABQ.wPQeDXB9RRBl4aR4X06DepFCAbGw.8C', 'usuario', 'default.png');
